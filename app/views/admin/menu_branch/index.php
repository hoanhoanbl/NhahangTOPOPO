...
<div class="container-fluid">
    <div class="card shadow p-4">
        <h3 class="mb-4">Qu?n lý Menu theo Co s?</h3>
        ...
        <form action="" method="GET">
            ...
            <div class="row g-3 align-items-end mb-4">
                <div class="col-md-4">
                    <label for="branch_id" class="form-label"><strong>Ch?n m?t co s? d? qu?n lý:</strong></label>
                    <select class="form-select" id="branch_id" name="branch_id" onchange="this.form.submit()" <?php echo $isGlobalAdmin ? '' : 'disabled'; ?>>
                        <option value="">-- Vui lòng ch?n co s? --</option>
        ...
        if ($selected_branch_id > 0) {
            ...
            echo '  Vui lòng ch?n m?t co s? t? danh sách ? trên d? xem và qu?n lý th?c don chi ti?t.';
            echo '</div>';
        }
        ?>
    </div>
