  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-warning text-dark">
        <h5 class="modal-title"><i class="fas fa-user-edit"></i> S?a Thông Tin Nhân Viên</h5>
      ...
      <div class="modal-body">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            <label class="form-label">Tên Ðang Nh?p</label>
          ...
          <div class="col-md-6">
            ...
            <small class="text-muted">Ð? tr?ng n?u không mu?n thay d?i m?t kh?u.</small>
          </div>

          <div class="col-md-6">
            <label class="form-label">Xác Nh?n M?t Kh?u</label>
          ...
          <div class="col-12">
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="updateChucVuReceptionist">L? Tân</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="ChucVu" id="updateChucVuManager" value="manager">
              <label class="form-check-label" for="updateChucVuManager">Qu?n Lý</label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="ChucVu" id="updateChucVuAdmin" value="admin">
              <label class="form-check-label" for="updateChucVuAdmin">Qu?n Tr? Viên</label>
            </div>
          </div>
        </div>
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" class="btn" style="background-color: #FFA827; border-color: #FFA827; color: #333;">
          <i class="fas fa-save"></i> C?p nh?t nhân viên
        </button>
      </div>
      </form>
    </div>
