...
$canUseResource = function (string $resource) use ($auth): bool {
    if (!$auth || !$auth->can($resource, 'read')) {
        return false;
    }
    if ($auth->isAdmin()) {
        return true;
    }
    return $auth->can($resource, 'create') || $auth->can($resource, 'update') || $auth->can($resource, 'delete');
};

$showMenu = $canUseResource('menu');
$showUsers = $canUseResource('staff');
$showBranches = $canUseResource('branch');
$showTable = $canUseResource('table');
$showBooking = $canUseResource('booking');
$showUudai = $canUseResource('uudai');

if ($section !== 'dashboard' && isset($sectionResourceMap[$section])) {
    $resource = $sectionResourceMap[$section];
    if (!$canUseResource($resource)) {
        $accessDeniedMessage = 'Bạn không có quyền truy cập mục "' . htmlspecialchars($section) . '".';
        $section = 'dashboard';
    }
}
?>
...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <?php if ($showMenu): ?>
            <li class="nav-item">
                <a class="nav-link <?php echo $section === 'menu' ? 'active' : ''; ?>" href="?page=admin&section=menu">
                    <i class="fas fa-utensils me-2"></i>
                    Quản lý Menu
                </a>
            </li>
        ...
        <header class="header d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <h1 class="h3 mb-0">
                    <?php
                    switch ($section) {
                        case 'menu': echo 'Quản lý Menu'; break;
                        ...
                        case 'booking': echo 'Quản lý Booking'; break;
        ...
        <div class="content-area">
            ...
            <div class="row mb-4">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <a href="?page=admin&section=menu" class="quick-action d-block">
