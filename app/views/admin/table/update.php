  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">S?a bàn</h5>
      ...
      <form id="updateTableForm" method="POST">
        <div class="modal-body">
          <div class="row g-3">
            <div class="col-md-6">
              <label class="form-label" for="updateMaCoSo">Co s?</label>
            ...
            <div class="col-md-4">
              <label class="form-label" for="updateTrangThai">Tr?ng thái</label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn" style="background-color: #FFA827; border-color: #FFA827; color: #333;">C?p nh?t bàn</button>
        </div>
      </form>
    </div>
  </div>
