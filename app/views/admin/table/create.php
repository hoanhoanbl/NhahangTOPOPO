  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header bg-success text-white">
        <h5 class="modal-title"><i class="fas fa-utensils me-2"></i> Thêm bàn m?i</h5>
      ...
      <form action="?page=admin&section=table&action=process-create" method="POST">
        <div class="modal-body">
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <label class="form-label" for="ZoneBan">Zone bàn</label>
              <input type="text" class="form-control" id="ZoneBan" name="ZoneBan" placeholder="VD: T?ng 1 - Trong nhà" required>
            </div>
            ...
            <div class="col-md-4">
              <label class="form-label" for="OnlineBookable">Ð?t online</label>
            ...
            <div class="col-md-4">
              <label class="form-label" for="TrangThai">Tr?ng thái</label>
            ...
            <div class="col-md-12">
              ...
              <textarea class="form-control" id="GhiChu" name="GhiChu" rows="2" placeholder="Ghi chú thêm (n?u có)"></textarea>
            </div>
          </div>
        </div>
