<main class="home-main">
    <section class="banner-brand">
        <div class="banner-brand-section">
            <img src="<?php echo asset('images/Home1.png'); ?>" alt="" class="home-banner-image">
                ...
                <div class="cs-main-content">
                            ...
                            <div class="cs-card">
                                ...
                                <div class="cs-card-details">
                                    ...
                                    <div class="cs-card-actions">
                                        <a href="?page=menu2&coso=<?php echo $branch['id']; ?>" class="btn-action">Đặt bàn ngay</a>
                    ...
                    <?php else: ?>
                        ...
                        <div class="cs-group" id="cs-group-ba-dinh">
                            <h3 class="cs-group-title">Hòa Xuân</h3>
                            <div class="cs-card">
                                <div class="cs-card-image">
